  ...
  return (
    <div className="page admin-page">
      ...
      <div className="admin-stats">
        <div className="stat-card"><div className="stat-number">{users.length}</div><div className="stat-label">{t("totalUsers")}</div></div>
        <div className="stat-card"><div className="stat-number">{reviews.length}</div><div className="stat-label">{t("totalReviews")}</div></div>
        <div className="stat-card"><div className="stat-number">{pendingReports.length}</div><div className="stat-label">{t("pendingReports")}</div></div>
        <div className="stat-card"><div className="stat-number">{users.filter((u) => u.role === "banned").length}</div><div className="stat-label">{t("bannedUsers")}</div></div>
      </div>
